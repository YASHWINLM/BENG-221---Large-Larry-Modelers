...
maaslin3_out_cholesterol = maaslin3(input_data = agglomerate(amplicon_matrix, amplicon_taxonomy, rank = 'Genus'),
...
maaslin3_out_acetate = maaslin3(input_data = agglomerate(amplicon_matrix, amplicon_taxonomy, rank = 'Genus'),
                    input_metadata = amplicon_metadata,
                    reference = reference_levels,
                    output = paste0('maaslin3/', response, '.out'),
                    formula = formula,
...
#"X..SCFA.Acetate"                                  
#[11] "X..SCFA.Butyrate"                                  "X..SCFA.Propionate"                               
# [13] "X..SCFA.Valerate"
## Define fixed effect terms
fixed_effect_terms = gsub(',.*', '', reference_levels) %>% c(numeric_vars)
...
maaslin3_out_butyrate = maaslin3(input_data = agglomerate(amplicon_matrix, amplicon_taxonomy, rank = 'Genus'),
                    input_metadata = amplicon_metadata,
                    reference = reference_levels,
                    output = paste0('maaslin3/', response, '.out'),
                    formula = formula,
...
maaslin3_out_propionoate = maaslin3(input_data = agglomerate(amplicon_matrix, amplicon_taxonomy, rank = 'Genus'),
                    input_metadata = amplicon_metadata,
                    reference = reference_levels,
                    output = paste0('maaslin3/', response, '.out'),
                    formula = formula,
...
maaslin3_out_valerate = maaslin3(input_data = agglomerate(amplicon_matrix, amplicon_taxonomy, rank = 'Genus'),
                    input_metadata = amplicon_metadata,
                    reference = reference_levels,
                    output = paste0('maaslin3/', response, '.out'),
                    formula = formula,
